...
import org.squaresaresquare.client.block.entity.custom.QuadrupleWindowArchRow2Col8BlockEntity;
...
public class QuadrupleWindowArchRow2Col8BlockEntityRenderer implements BlockEntityRenderer<QuadrupleWindowArchRow2Col8BlockEntity, QuadrupleWindowArchRow2Col8BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(QuadrupleWindowArchRow2Col8BlockEntity blockEntity, QuadrupleWindowArchRow2Col8BlockEntityRenderState state, float tickProgress, Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
        BlockEntityRenderer.super.extractRenderState(blockEntity, state, tickProgress, cameraPos, crumblingOverlay);
    }

    @Override
    public void submit(QuadrupleWindowArchRow2Col8BlockEntityRenderState state, PoseStack matrices, SubmitNodeCollector queue, CameraRenderState cameraState) {
        matrices.pushPose();

...
public class QuadrupleWindowArchRow2Col2BlockEntityRenderer implements BlockEntityRenderer<QuadrupleWindowArchRow2Col2BlockEntity, QuadrupleWindowArchRow2Col2BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(QuadrupleWindowArchRow2Col2BlockEntity blockEntity, QuadrupleWindowArchRow2Col2BlockEntityRenderState state, float tickProgress, Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
        BlockEntityRenderer.super.extractRenderState(blockEntity, state, tickProgress, cameraPos, crumblingOverlay);
    }

    @Override
    public void submit(QuadrupleWindowArchRow2Col2BlockEntityRenderState state, PoseStack matrices, SubmitNodeCollector queue, CameraRenderState cameraState) {
        matrices.pushPose();

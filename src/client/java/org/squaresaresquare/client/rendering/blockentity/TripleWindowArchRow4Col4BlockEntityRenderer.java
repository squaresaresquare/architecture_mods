...
import org.squaresaresquare.client.block.entity.custom.TripleWindowArchRow4Col4BlockEntity;
...
public class TripleWindowArchRow4Col4BlockEntityRenderer implements BlockEntityRenderer<TripleWindowArchRow4Col4BlockEntity, TripleWindowArchRow4Col4BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(TripleWindowArchRow4Col4BlockEntity blockEntity, TripleWindowArchRow4Col4BlockEntityRenderState state, float tickProgress, Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
        BlockEntityRenderer.super.extractRenderState(blockEntity, state, tickProgress, cameraPos, crumblingOverlay);
    }

    @Override
    public void submit(TripleWindowArchRow4Col4BlockEntityRenderState state, PoseStack matrices, SubmitNodeCollector queue, CameraRenderState cameraState) {
        matrices.pushPose();

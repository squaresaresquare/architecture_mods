...
import org.squaresaresquare.client.block.entity.custom.TripleWindowArchRow2Col1BlockEntity;
...
public class TripleWindowArchRow2Col1BlockEntityRenderer implements BlockEntityRenderer<TripleWindowArchRow2Col1BlockEntity, TripleWindowArchRow2Col1BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(TripleWindowArchRow2Col1BlockEntity blockEntity, TripleWindowArchRow2Col1BlockEntityRenderState state, float tickProgress, Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
        BlockEntityRenderer.super.extractRenderState(blockEntity, state, tickProgress, cameraPos, crumblingOverlay);
    }

    @Override
    public void submit(TripleWindowArchRow2Col1BlockEntityRenderState state, PoseStack matrices, SubmitNodeCollector queue, CameraRenderState cameraState) {
        matrices.pushPose();

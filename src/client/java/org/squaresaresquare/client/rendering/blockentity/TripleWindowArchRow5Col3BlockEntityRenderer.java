...
import org.squaresaresquare.client.block.entity.custom.TripleWindowArchRow5Col3BlockEntity;
...
public class TripleWindowArchRow5Col3BlockEntityRenderer implements BlockEntityRenderer<TripleWindowArchRow5Col3BlockEntity, TripleWindowArchRow5Col3BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(TripleWindowArchRow5Col3BlockEntity blockEntity, TripleWindowArchRow5Col3BlockEntityRenderState state, float tickProgress, Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
        BlockEntityRenderer.super.extractRenderState(blockEntity, state, tickProgress, cameraPos, crumblingOverlay);
    }

    @Override
    public void submit(TripleWindowArchRow5Col3BlockEntityRenderState state, PoseStack matrices, SubmitNodeCollector queue, CameraRenderState cameraState) {
        matrices.pushPose();

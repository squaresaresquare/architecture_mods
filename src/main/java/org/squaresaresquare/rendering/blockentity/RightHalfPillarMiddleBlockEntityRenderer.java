...
public class RightHalfPillarMiddleBlockEntityRenderer implements BlockEntityRenderer<RightHalfPillarMiddleBlockEntity, RightHalfPillarMiddleBlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(RightHalfPillarMiddleBlockEntity blockEntity, RightHalfPillarMiddleBlockEntityRenderState state, float tickProgress, @NotNull Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
        BlockEntityRenderer.super.extractRenderState(blockEntity, state, tickProgress, cameraPos, crumblingOverlay);
    }

    @Override
    public void submit(RightHalfPillarMiddleBlockEntityRenderState state, PoseStack matrices, @NotNull SubmitNodeCollector queue, @NotNull CameraRenderState cameraState) {
        matrices.pushPose();

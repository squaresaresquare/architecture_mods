...
public class QuadrupleWindowArchRow3Col7BlockEntityRenderer implements BlockEntityRenderer<QuadrupleWindowArchRow3Col7BlockEntity, QuadrupleWindowArchRow3Col7BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(QuadrupleWindowArchRow3Col7BlockEntity blockEntity, QuadrupleWindowArchRow3Col7BlockEntityRenderState state, float tickProgress, @NotNull Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
        BlockEntityRenderer.super.extractRenderState(blockEntity, state, tickProgress, cameraPos, crumblingOverlay);
    }

    @Override
    public void submit(QuadrupleWindowArchRow3Col7BlockEntityRenderState state, PoseStack matrices, @NotNull SubmitNodeCollector queue, @NotNull CameraRenderState cameraState) {
        matrices.pushPose();

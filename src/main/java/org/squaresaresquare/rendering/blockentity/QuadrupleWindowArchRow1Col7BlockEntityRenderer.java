...
public class QuadrupleWindowArchRow1Col7BlockEntityRenderer implements BlockEntityRenderer<QuadrupleWindowArchRow1Col7BlockEntity, QuadrupleWindowArchRow1Col7BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(QuadrupleWindowArchRow1Col7BlockEntity blockEntity, QuadrupleWindowArchRow1Col7BlockEntityRenderState state, float tickProgress, @NotNull Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
        BlockEntityRenderer.super.extractRenderState(blockEntity, state, tickProgress, cameraPos, crumblingOverlay);
    }

    @Override
    public void submit(QuadrupleWindowArchRow1Col7BlockEntityRenderState state, PoseStack matrices, @NotNull SubmitNodeCollector queue, @NotNull CameraRenderState cameraState) {
        matrices.pushPose();

...
import org.squaresaresquare.block.entity.custom.QuadrupleWindowArchRow1Col8BlockEntity;
...
public class QuadrupleWindowArchRow1Col8BlockEntityRenderer implements BlockEntityRenderer<QuadrupleWindowArchRow1Col8BlockEntity, QuadrupleWindowArchRow1Col8BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(QuadrupleWindowArchRow1Col8BlockEntity blockEntity, QuadrupleWindowArchRow1Col8BlockEntityRenderState state, float tickProgress, @NotNull Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
        BlockEntityRenderer.super.extractRenderState(blockEntity, state, tickProgress, cameraPos, crumblingOverlay);
    }

    @Override
    public void submit(QuadrupleWindowArchRow1Col8BlockEntityRenderState state, PoseStack matrices, @NotNull SubmitNodeCollector queue, @NotNull CameraRenderState cameraState) {
        matrices.pushPose();

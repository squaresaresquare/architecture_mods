...
public class RightHalfPillarCapBlockEntityRenderer implements BlockEntityRenderer<RightHalfPillarCapBlockEntity, RightHalfPillarCapBlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(RightHalfPillarCapBlockEntity blockEntity, RightHalfPillarCapBlockEntityRenderState state, float tickProgress, @NotNull Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
        BlockEntityRenderer.super.extractRenderState(blockEntity, state, tickProgress, cameraPos, crumblingOverlay);
    }

    @Override
    public void submit(RightHalfPillarCapBlockEntityRenderState state, PoseStack matrices, @NotNull SubmitNodeCollector queue, @NotNull CameraRenderState cameraState) {
        matrices.pushPose();
